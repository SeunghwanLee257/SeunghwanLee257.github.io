...
const translations = {
  en: {
    ...
    'portfolio.b': 'B. PET risk intelligence PoC validation<br><span>Insurance claim cross-check, FDS, identity and anomaly workflows</span>',
    ...
    'roadmap.b.title': 'B. Enterprise PET Validation',
  ...
  ko: {
    ...
    'portfolio.b': 'B. PET 리스크 인텔리전스 PoC 검증<br><span>보험 청구 교차검증, FDS, 신원 및 이상 거래 워크플로</span>',
