...
const translations = {
  en: {
    ...
    'vision.subtitle': 'waLLLnut applies FHE16, MPC, and threshold disclosure to build a staged business:<br>consumer demand intelligence first, enterprise PET risk pilots next, and blockchain confidential infrastructure as the scalable layer.',
    ...
    'property.feature2': 'B converts the same PET engine into enterprise pilots for insurance claim review, identity risk, FDS, and anomalous transaction workflows.',
    ...
    'usecase.2.desc': 'Insurance claim cross-validation, FDS, identity mismatch, and anomalous transaction screening without moving raw customer data. GTM path: PoC, paid pilot, subscription or per-check pricing.',
  ...
  ko: {
    ...
    'vision.subtitle': 'waLLLnut은 FHE16, MPC, 임계값 공개 기술로 단계형 사업을 구축합니다:<br>B2C 수요 인텔리전스로 시작하고, B2B PET 리스크 파일럿으로 확장하며, 블록체인 기밀 인프라를 장기 확장 레이어로 만듭니다.',
    ...
    'property.feature2': 'B는 같은 PET 엔진을 보험 청구 검토, 신원 리스크, FDS, 이상 거래 업무를 위한 기업 파일럿으로 전환합니다.',
    ...
    'usecase.2.desc': '원본 고객 데이터를 이동하지 않고 보험 청구 교차검증, FDS, 신원 불일치, 이상 거래 선별을 수행합니다. GTM은 PoC, 유료 파일럿, 구독 또는 건당 과금으로 이어집니다.',
