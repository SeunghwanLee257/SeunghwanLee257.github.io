...
const translations = {
  en: {
    ...
    'nav.solutions': 'Solutions',
      ...
      'nav.demo.playground': 'Playground',
      'nav.demo.compiler': 'JS Compiler',
    'nav.tech': 'Technology',
    'nav.team': 'Team',
    'hero.headline': 'Put your most sensitive data to work<br>— without ever exposing it.',
    ...
    'vision.subtitle': 'It starts with a consumer demand product, extends to enterprise risk checks,<br>and grows the same engine into confidential blockchain infrastructure.',
    ...
    'property.feature1': 'A is the first product: private demand and allocation reports for consumer launches.',
    ...
    'usecases.title': 'Products & business model',
    ...
    'summary.headline': 'One privacy engine, three products.',
    'summary.body': 'The same FHE16 engine powers all three — consumer demand forecasting today, enterprise risk checks next, and on-chain confidentiality as it scales.',
    'summary.status.entry.label': 'Where we start',
    ...
    'summary.status.engine.label': 'Core technology',
    'summary.status.engine.value': 'FHE16 runtime + MPC key layer',
    'summary.status.rule.label': 'What we guarantee',
    ...
    'developers.github.desc': 'The browser runtime as one file (fhe16.js), plus implementation references and research code',
  ...
  ko: {
    ...
    'nav.solutions': '솔루션',
      'nav.solution.fhe16': 'FHE16',
      'nav.demo.playground': '플레이그라운드',
      'nav.demo.compiler': 'JS 컴파일러',
    'nav.tech': '기술',
    'nav.team': '팀',
    'hero.headline': '가장 민감한 데이터를 그대로 활용합니다<br>— 원본은 한 번도 드러내지 않고',
    ...
    'vision.subtitle': '같은 엔진을 단계별로 넓혀 갑니다:<br>소비자 수요 예측으로 시작해, 기업 리스크 검증으로 확장하고, 온체인 기밀 인프라로 키웁니다.',
    ...
    'property.feature1': 'A는 첫 제품입니다: 소비자 출시와 물량 계획을 위한 비공개 수요 리포트.',
    ...
    'summary.headline': '하나의 프라이버시 엔진, 세 개의 제품.',
    'summary.body': '같은 FHE16 엔진이 셋을 모두 움직입니다 — 지금은 소비자 수요 예측, 다음은 기업 리스크 검증, 확장 단계에서는 온체인 기밀성.',
    'summary.status.entry.label': '시작 지점',
    'summary.status.entry.value': 'A. B2C 수요',
    'summary.status.launch.label': '출시 상태',
    'summary.status.launch.value': '2026 Coming Soon',
    'summary.status.engine.label': '핵심 기술',
    'summary.status.engine.value': 'FHE16 런타임 + MPC 키 레이어',
    'summary.status.rule.label': '보안 약속',
    ...
    'developers.github.desc': '브라우저 런타임 파일 하나(fhe16.js)와 구현 레퍼런스, 연구 코드를 확인하세요',
